...
namespace NetworkDisintegration_02
{
    class Program
    {
        /* YN 3/12/21 - Doing a simulation of a network disintegration and recording the results with their associated costs.
         * A 'cost' here is how many times we paid it, we will multiply these by the actual costs in Python when we plot the
         * results. A typical result should include:
         * 
         * A vector of the max component of the graph
         * A vector of the second largest component of the graph
         * CvAll vector - Total costs of interviewing a vertex, assuming we pay it even when we are interviewing for the second time
         * CvUnq vector - Total costs of interviewing a vertex assuming we only pay the first time
         * CnAll vector - Total costs of interviewing a neighbor, assume we it even for the second time for the same vertex
         * CnUnq vector - Total costs of interviewing a neighbor, assume we only pay the first time
         * Cs vector - Total costs of selecting any vertex, v or n.
         */
